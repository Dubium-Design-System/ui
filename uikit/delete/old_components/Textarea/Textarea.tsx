		...
		(
			...
			useEffect(() => {
				if (localRef.current) {
					...
					const computedStyle = window.getComputedStyle(localRef.current)
					...
					const calculatedHeight = rows * lineHeight + paddingTop + paddingBottom + borderTop + borderBottom
			...
			const adjustHeight = useCallback(() => {
				...
				const newHeight = Math.min(Math.max(textarea.scrollHeight, baseHeight), maxHeight)
