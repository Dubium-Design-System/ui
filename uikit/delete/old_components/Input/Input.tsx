...
type InputType = "text" | "number" | "email" | "tel" | "url" | "password" | "date" | "search"
type InputModeType = "text" | "email" | "tel" | "url" | "none" | "numeric" | "decimal" | "search" | undefined
...
interface InputProps extends InputHTMLAttributes<HTMLInputElement> {
	 ...
	 * @defaultValue 'enter'
	 */
	enterKeyHint?: "enter" | "next" | "previous" | "done" | "go" | "search" | "send"
	...
	(
		...
		useEffect(() => {
			if (value !== undefined && typeof onChange !== "function") {
				console.warn('Input is a controlled component, but "onChange" is not provided.')
			}
		}, [value, onChange])
		...
		useEffect(() => {
			if (autoFocus && !disabled && combinedRef.current && scrollIntoViewOnFocus) {
