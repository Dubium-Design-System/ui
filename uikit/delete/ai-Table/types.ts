...
export interface Column<T extends object> {
	 ...
	 */
	render?(args: { text: T[keyof T] | undefined; record: T; index: string | number }): ReactNode
}
...
export interface TablePropsWithSettings<T extends { id?: string | number }> extends TableProps<T>, TableSettings<T> {}
