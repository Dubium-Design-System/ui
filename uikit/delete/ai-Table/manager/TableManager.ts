...
export class TableManager<T extends object> {
	...
	private getModuleInstance<M extends TableModule>(name: ModuleName, factory: () => M): M {
	...
	public get filter() {
		...
		return this.getModuleInstance("filter", () => new FilterModule<T>(this))
	}

	public get column() {
		if (!this.isModuleEnabled("column")) return null
		return this.getModuleInstance("column", () => new ColumnModule<T>(this))
	}

	public get search() {
		if (!this.isModuleEnabled("search")) return null
		return this.getModuleInstance("search", () => new SearchModule<T>(this))
	}

	public get pagination() {
		if (!this.isModuleEnabled("pagination")) return null
		return this.getModuleInstance("pagination", () => new PaginationModule<T>(this))
	}
